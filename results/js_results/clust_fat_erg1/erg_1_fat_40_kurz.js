...
var recipes_top10 = [16470, 19423, 68613, 229994, 8829, 8543, 22725, 14140, 11683,

       19422
];

var recipes_user = [12066, 158587,  17253,  16473,   8772,  35469,  20458,   8756,

       238100, 228134, 229277,  13420,  11767,  24683,  72277, 149738,

        23434,  16563,  59303,  14735,  18439, 111823,  16794,  17169,

        42967, 106528, 142220,   8855, 228431,  30007, 127500, 237320,

        52501,  3869,   8710,  11990, 177777, 231233
];
...
print("Einzigartige Ueberschneidungszutaten TOP10 VS Userprofil: " + ing_intersect.length + "\n" +
    ...
    "�berschneidunutaten Top10: " + b.toFixed(2).toString().replace(".", ",") + "\n"
